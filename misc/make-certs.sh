...
openssl req -new -out $1/mme.csr -key $1/mme.key \
...
openssl req -new -out $1/hss.csr -key $1/hss.key \
...
openssl req -new -out $1/smf.csr -key $1/smf.key \
...
openssl req -new -out $1/pcrf.csr -key $1/pcrf.key \
