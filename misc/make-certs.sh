...
openssl ca -cert $1/ca.crt -keyfile $1/ca.key -in $1/mme.csr -out $1/mme.crt -outdir . -notext -days 3650 -batch
...
openssl ca -cert $1/ca.crt -keyfile $1/ca.key -in $1/hss.csr -out $1/hss.crt -outdir . -notext -days 3650 -batch
...
openssl ca -cert $1/ca.crt -keyfile $1/ca.key -in $1/smf.csr -out $1/smf.crt -outdir . -notext -days 3650 -batch
...
openssl ca -cert $1/ca.crt -keyfile $1/ca.key -in $1/pcrf.csr -out $1/pcrf.crt -outdir . -notext -days 3650 -batch
